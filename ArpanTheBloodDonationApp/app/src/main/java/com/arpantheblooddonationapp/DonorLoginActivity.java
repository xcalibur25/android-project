 ...
 */
public class DonorLoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {

    public void donorSignUp (View view){
        TextView signUp = (TextView)findViewById(R.id.signUp);
        Intent donorSignUp = new Intent(DonorLoginActivity.this, DonorSignUp.class);
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(DonorLoginActivity.this,
